...
public class AggregateFilterToCaseRule
  ...
  private static AggregateCall transform(AggregateCall call,
    ...
    return AggregateCall.create(call.getAggregation(), call.isDistinct(),
  ...
  public interface Config extends RelRule.Config {
    Config DEFAULT = ImmutableAggregateFilterToCaseRule.Config.builder()
        .operandSupplier(b0 ->
            b0.operand(Aggregate.class).oneInput(b1 ->
                b1.operand(Project.class).anyInputs())).build();
