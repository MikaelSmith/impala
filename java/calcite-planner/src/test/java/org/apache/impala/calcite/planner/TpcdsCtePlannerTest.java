 ...
 * copy of {@link org.apache.impala.planner.TpcdsCpuCostPlannerTest} with few tweaks
 * to trigger CTE recommendations. The test only verifies single node plans since
...
public class TpcdsCtePlannerTest extends PlannerTestBase {
  ...
  public static Collection<Object[]> queries() {
    ...
    for (int i = 1; i <= 99; i++) {
      // IMPALA-15243: Error while applying rule MaterializedViewFilterScanRule for TPC-DS
      // Q39
      if (i == 39) { continue; }
