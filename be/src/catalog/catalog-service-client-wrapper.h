...
class CatalogServiceClientWrapper : public CatalogServiceClient {
 public:
  ...
  void ExecDdlWithRetry(
      TDdlExecResponse& _return, const TDdlExecRequest& req, bool* send_done) {
    DCHECK(!*send_done);
    send_ExecDdl(req);
    *send_done = true;
  ...
  void ResetMetadataWithRetry(TResetMetadataResponse& _return,
      const TResetMetadataRequest& req, bool* send_done) {
    DCHECK(!*send_done);
  ...
  void UpdateCatalogWithRetry(TUpdateCatalogResponse& _return,
      const TUpdateCatalogRequest& req, bool* send_done) {
    DCHECK(!*send_done);
  ...
  void PrioritizeLoadWithRetry(TPrioritizeLoadResponse& _return,
      const TPrioritizeLoadRequest& req, bool* send_done) {
    DCHECK(!*send_done);
