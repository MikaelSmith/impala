...
#include "gutil/legacy_atomics/atomicops-internals-tsan.h"
#elif defined(__GNUC__) && defined(__aarch64__)
#include "gutil/legacy_atomics/atomicops-internals-arm64.h"
#elif defined(__GNUC__) && (defined(__i386) || defined(__x86_64__))
#include "gutil/legacy_atomics/atomicops-internals-x86.h"
#else
...
inline AtomicWord Acquire_CompareAndSwap(volatile AtomicWord* ptr,
                                         AtomicWord old_value,
                                         AtomicWord new_value) {
  return legacy::base::subtle::Acquire_CompareAndSwap(
      reinterpret_cast<volatile AtomicWordCastType*>(ptr),
      old_value, new_value);
}
...
inline AtomicWord Release_CompareAndSwap(volatile AtomicWord* ptr,
                                         AtomicWord old_value,
                                         AtomicWord new_value) {
  return legacy::base::subtle::Release_CompareAndSwap(
      reinterpret_cast<volatile AtomicWordCastType*>(ptr),
      old_value, new_value);
}
...
inline void Acquire_Store(volatile AtomicWord* ptr, AtomicWord value) {
  return legacy::base::subtle::Acquire_Store(
      reinterpret_cast<volatile AtomicWordCastType*>(ptr), value);
}

inline void Release_Store(volatile AtomicWord* ptr, AtomicWord value) {
  return legacy::base::subtle::Release_Store(
      reinterpret_cast<volatile AtomicWordCastType*>(ptr), value);
}
...
inline AtomicWord Acquire_Load(volatile const AtomicWord* ptr) {
  return legacy::base::subtle::Acquire_Load(
      reinterpret_cast<volatile const AtomicWordCastType*>(ptr));
}

inline AtomicWord Release_Load(volatile const AtomicWord* ptr) {
  return legacy::base::subtle::Release_Load(
      reinterpret_cast<volatile const AtomicWordCastType*>(ptr));
}

}  // namespace legacy::base::subtle
}  // namespace legacy::base
}  // namespace legacy
