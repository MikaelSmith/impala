...
class TestStreamingTable(ImpalaTestSuite):
  ...
  def test_streaming_logical_update(self, vector, unique_database):
    self.run_test_case('QueryTest/streaming-logical-update', vector,
                       use_db=unique_database)

  def test_streaming_logical_update_non_unique(self, vector, unique_database):
    self.run_test_case('QueryTest/streaming-logical-update-non-unique', vector,
                       use_db=unique_database)
